...
Подробнее: [docs/persistence-context.md](docs/persistence-context.md), [docs/dirty-checking.md](docs/dirty-checking.md)
...
Подробнее: [docs/n-plus-one.md](docs/n-plus-one.md)
...
Подробнее: [docs/aop-proxy-gotcha.md](docs/aop-proxy-gotcha.md), [docs/OptimisticLockException.md](docs/OptimisticLockException.md)
